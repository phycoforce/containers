...
![GitHub Repo stars](https://img.shields.io/github/stars/phycoforce/containers?style=for-the-badge)
![GitHub forks](https://img.shields.io/github/forks/phycoforce/containers?style=for-the-badge)
![GitHub Workflow Status (with event)](https://img.shields.io/github/actions/workflow/status/phycoforce/containers/release.yaml?style=for-the-badge&label=Release)

</div>

Welcome to our container images! If you are looking for a container, start by [browsing the GitHub Packages page for this repository's packages](https://github.com/orgs/phycoforce/packages?repo_name=containers).
...
```sh
gh attestation verify --repo phycoforce/containers oci://ghcr.io/phycoforce/${APP}:${TAG}
```
...
cosign verify-attestation --new-bundle-format --type slsaprovenance1 \
    ...
    --certificate-identity-regexp "^https://github.com/phycoforce/containers/.github/workflows/app-builder.yaml@refs/heads/main" \
    ghcr.io/phycoforce/${APP}:${TAG}
```
...
- **qBittorrent** is only published with **LibTorrent 2.x**. See [this issue](https://github.com/phycoforce/containers/issues/848) for more information.
